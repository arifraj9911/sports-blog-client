    ...
    <div className="w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-lg ">
      ...
      <div className="px-6 py-4">
        ...
        <div className="mt-10 flex gap-3 justify-end">
          ...
          <button className="flex items-center px-4 py-2 font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-[#4F6F52] rounded-lg hover:bg-[#75A47F] focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80">
            <svg
